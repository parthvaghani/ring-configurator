...
export const Scene3D: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const initViewer = async () => {
      ...
      viewer.setBackground(new Color('#161628').convertSRGBToLinear());
      ...
      importer.addEventListener('onLoad', async () => {
        ...
        camera.position.set(-0.17, -0.25, 8.5);
        ...
        if (isMobile) {
          ...
          camera.setCameraOptions({ fov: 60 });
        }
      ...
      viewer.addEventListener('preFrame', () => {
        // keep hook for future animations
      });
